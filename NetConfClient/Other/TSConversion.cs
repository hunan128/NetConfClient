...
namespace NetConfClientSoftware
{
    class TSConversion
    {
        public static string Ts (string OtuRate, string Oduk,string TsInt){
            ...
            if (OtuRate.Contains("10GE") && (Oduk.Contains("ODU2")|| Oduk.Contains("ODU2e"))) { ts_detai = "8-FF"; }
            if (OtuRate.Contains("10Gb") && (Oduk.Contains("ODU2") || Oduk.Contains("ODU2e"))) { ts_detai = "8-FF"; }
            return ts_detai;
