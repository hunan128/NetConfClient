...
namespace NetConfClientSoftware
{
    class CreateETH
    {
        public static XmlDocument Common(string ips, string _Create_Connection, string _label, string _service_type, string _layer_protoco_name, string _cir, string _pir, string _cbs, string _pbs, string _uni_protection_type, string _service_mapping_mode,
