...
namespace Renci.SshNet
{
    ...
    public class NetConfClient : BaseClient
    {
        ...
        {
            return _netConfSession.SendReceiveRpc(rpc, AutomaticMessageIdHandling, TimeOut);
        }
        /// <summary>
        /// Sends the receive RPC.
        /// </summary>
        /// <returns>Reply message to RPC request</returns>
        public string SendReceiveRpcSub()
        {
        ...
        {
             _netConfSession.SendReceiveRpcKeepLive();
        }
        /// <summary>
        /// Sends the receive RPC.
        /// </summary>
        ...
        {
            var rpc = new XmlDocument();
            rpc.LoadXml("<?xml version=\"1.0\" encoding=\"UTF-8\"?>" +
                "<rpc message-id=\"6666\" xmlns=\"urn:ietf:params:xml:ns:netconf:base:1.0\">" +
                "<close-session/>" +
                "</rpc>");
            return _netConfSession.SendReceiveRpc(rpc, AutomaticMessageIdHandling, TimeOut);
        }
